...
export function Step4Review({ onEditStep }) {
    ...
    const logoPreview = orgLogo instanceof File ? URL.createObjectURL(orgLogo) : null;
                ...
                <CardContent className="pt-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm" dir="ltr">{contactEmail || "-"}</span>
                        </div>
                        {contactPhone && (
                            <div className="flex items-center gap-2">
                        ...
                        {orgWebsite && (
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm truncate" dir="ltr">{orgWebsite}</span>
                            </div>
                        )}
                    ...
                    {hasSocialLinks && (
                        <div className="mt-4 pt-4 border-t">
                            <p className="text-xs text-muted-foreground mb-2">حسابات التواصل الاجتماعي</p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {registrationNumber && (
                                <div>
                                    ...
                                    <p className="text-sm font-medium" dir="ltr">{registrationNumber}</p>
                                </div>
                            )}
                            {taxId && (
                                <div>
                                    <p className="text-xs text-muted-foreground">الرقم الضريبي</p>
                                    <p className="text-sm font-medium" dir="ltr">{taxId}</p>
                                </div>
                            )}
                        </div>
                    ) : (
