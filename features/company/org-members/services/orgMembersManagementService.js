...
export async function createInvite(
  ...
  try {
    ...
    console.error(
      "[createInvite] Failed to send invitation email:",
      err.message,
    );
  }
...
export async function findPendingInviteByEmail(email) {
  ...
  const results = await client.fetch(
    teamMemberInviteQueries.findPendingInviteByEmail,
    {
      email: normalizedEmail,
    },
  );
...
export const orgMembersManagementService = {
  getInvites,
  createInvite,
  deleteInvite,
  getInviteByEmail,
...
export const teamMemberManagementService = orgMembersManagementService;
