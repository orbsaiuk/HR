...
const steps = [
    {
        ...
        description: "نرشدك لإتمام كل الإجراءات الرسمية والتراخيص بسرعة وسهولة، لتبدأ مشروعك بدون أي عقبات."
    },
    {
        number: "02",
        title: "إعداد خطة عمل استراتيجية",
        description: "نساعدك على وضع خطة واضحة تشمل دراسة السوق وتحليل المنافسين لضمان قرارات مدروسة."
    },
    {
        number: "03",
        title: "تنظيم الهيكل الإداري",
        description: "نصمم هيكل يوضح الأدوار والمسؤوليات لكل فرد لضمان سير العمل بسلاسة منذ البداية."
    },
    {
        number: "04",
        title: "استشارات تشغيل وتطوير",
        description: "نوفر استشارات عملية لتنظيم التشغيل وتحسين الكفاءة، مع تجنب الأخطاء الشائعة في المراحل الأولى."
    }
];
            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="text-center">
                    ...
                    <p className="text-base md:text-2xl leading-relaxed mb-10 sm:mb-16">
                        نساعدك على الانطلاق بأساس قانوني وتنظيمي قوي يضمن بداية مستقرة وواضحة.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col gap-4">
                        {steps.map((step) => (
                            ...
                            >
                                {/* Number */}
                                <div className="flex-shrink-0 bg-[#DBEEFF] rounded-full p-1">
