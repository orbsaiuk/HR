      ...
      <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-[#6B7280] sm:text-base">
            أنشئ عقدك وابعته على الواتساب لضمان حقوقك
          </p>
        </div>
      ...
      <div className="rounded-lg border border-[#E4E8F2] bg-white p-4 sm:p-5">
        ...
        <div className="mt-6 rounded-md bg-[#FFF8F8] p-5 text-center">
          ...
          <p className="mt-2 text-sm leading-7 text-[#6B7280]">
            اختر القالب المناسب حسب احتياجك، عبئه مباشرة على واتساب للموظف أو
            الفريلانسر. العقد يكون ملزم وواضح ومنظم يضمن حقوق الطرفين، ويمكنك
            أيضاً نسخ العقد وإلصاقه في أي مكان آخر.
          </p>
        </div>
      </div>
