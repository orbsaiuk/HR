            ...
            <div className="container mx-auto px-4 py-10 sm:py-16 md:py-20 text-center relative z-10">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-6 md:mb-8 leading-tight text-gray-900">
                    ...
                    <span className="relative inline-block">
                        <span className="relative z-10 text-red-700">الوظيفة</span>
                ...
                <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto mb-1 sm:mb-2 leading-relaxed">
                    استكشف مجموعة متنوعة من فرص العمل لدى شركات تبحث عن مهارات مثلك.
                </p>
                <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10 leading-relaxed">
                    ابحث بسهولة، قدّم بسرعة، وابدأ رحلتك المهنية بخطوة واثقة نحو مستقبلك.
                </p>

                {/* Search bar - separate bordered boxes */}
                <form
                ...
                >
                    ...
                    <div className="relative w-full sm:flex-1 sm:max-w-[320px]">
                        ...
                        <Input
                            ...
                            placeholder="المسمى الوظيفي أو كلمة مفتاحية"
                    ...
                    <div className="w-full sm:w-[200px]">
                        <Select
                            dir="rtl"
                            value={searchLocation || "all"}
                            onValueChange={(v) =>
                                onSearchLocationChange(v === "all" ? "" : v)
                            }
                        >
                            <SelectTrigger className="bg-white border border-gray-300 rounded-md text-gray-700 h-12 gap-2 text-sm w-full">
