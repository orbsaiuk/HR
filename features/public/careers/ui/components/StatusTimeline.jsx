                    ...
                    return (
                        <div key={stage} className="flex items-center flex-1 last:flex-none">
                            <div className="flex flex-col items-center">
                                <div
                                    className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium transition-all ${isActive
                                ...
                                <span
                                    className={`text-xs mt-1.5 whitespace-nowrap ${isActive
                            ...
                            {index < PIPELINE_STAGES.length - 1 && (
                                <div
                                    className={`flex-1 h-0.5 mx-2 -mt-4 ${isCompleted ? "bg-green-500" : "bg-gray-200"
                                        }`}
                                />
                            )}
                        </div>
