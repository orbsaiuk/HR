    ...
    <div className="space-y-4 print:space-y-2">
      ...
      <div className="hidden print:block print:mb-4">
        <h1 className="text-xl font-bold text-center">
          {form.title || "Form Responses Comparison"}
        </h1>
        <p className="text-center text-sm text-gray-600 mt-1">
          Comparing {responses.length} response
          {responses.length !== 1 ? "s" : ""} • {totalFields} field
          {totalFields !== 1 ? "s" : ""}
        </p>
          ...
          <Table className="print:text-xs">
            ...
            <TableBody>
              {filteredFields.map((field, fieldIndex) => {
                const originalIndex =
                  form.fields?.findIndex((f) => f._key === field._key) ??
                  fieldIndex;
                return (
                  <CompareTableRow
                    key={field._key}
              ...
              {!form.fields?.length && (
                <TableRow>
                  ...
                  >
                    ...
                    <p className="text-muted-foreground text-sm mt-1">
                      This form doesn't have any fields to compare.
                    </p>
                  </TableCell>
                </TableRow>
              )}
